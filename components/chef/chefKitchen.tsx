...
export default function ChefKitchen() {
  ...
  const products = [
    ...
    {
      id: 2,
      title: "Samsa with chicken meat",
      description: "Samsa with chicken meat",
      price: "$3.88",
      image: five
    },
    {
      id: 3,
      title: "Samsa with mushrooms and cheese",
      description: "Samsa with mushrooms and cheese",
      price: "$9.00",
      image: six,
    },
    {
      ...
      {
        id: 3,
        title: "Americano - Fall Oat Boy",
        description: "Americano - Fall Oat Boy",
        price: "$9.00",
        image: eight,
      },
      {
        id: 3,
        title: "Samsa with mutton",
        description: "Samsa with mutton",
        price: "$14.00",
        image: nine,
      },
  ];
  const chefs = [
    ...
    {
      image: "https://webstrot.com/html/lunchbox/lunchbox/images/chef3.png",
      id: "fran",
      name: "Fran Rushing",
      role: "Sr. Chef",
    },
  ...
  return (
          ...
          <SwiperSlide key={product.id}>
            ...
            <div className='productCard'>
              ...
              <div className='cardBody'>
                ...
                <p className="tests">{product.description}</p>
    ...
    <section className="ourChefs">
      <h2>Our Chefs</h2>
      <p className="tests">Meet our Chefs that make us Healthy and Fit</p>
      <div className="ourChefInner">
        {chefs.map((chef) => (
          <div className="ourChefimg" key={chef.id}>
            ...
            <div className="ourchefContent">
              <h4>
                <Link href={`/chef-details/${chef.id}`}>
                  {chef.name}
                </Link>
              </h4>
