...
const Group = ()=> {
    ...
    const chefs = [
        ...
        { image: "https://webstrot.com/html/lunchbox/lunchbox/images/chef7.png", id: "henny", name: "Henny Calvin", role: "Sr. Chef", group: "VIP Chef", groupId: 'vip-chef',trustYou: "110", bestSale: "400", rating: "4.5", lowSale:"50", lowRating:"43",},
         ...
         {image:chef15, id:"faith", role: "Sr. Chef", group: "Premium Chef", groupId: 'premium-chef',  name:'Faith',trustYou: "90", bestSale: "500", rating: "3.5", lowSale:"55", lowRating:"30",},
     ...
     const filteredChef = chefs.filter((chef) => chef.groupId === group)
     const navigateToChefPage = (id) => {
        router.push(`/chef-details/${id}`);
      };
   
    return(
        <div className="chefGrids">
        {filteredChef?.map((chef, index) => (
             <section className="" key={chef.id}>
             <div className="ourChefimg" >
